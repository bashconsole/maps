/****************************************************************************
** $Id: qt/examples/dirview/dirview.h   2.2.0-beta2   edited 2000-08-02 $
**
...
public:
    DirectoryView( QWidget *parent, const char *name = 0, bool sdo = FALSE);
...
signals:
    ...
    void newFolderSelected( const QString & );
